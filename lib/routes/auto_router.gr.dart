...
import 'package:cft/test_log/test_log_page.dart' as _i6;
...
class ImmediateMemoryRoute extends _i7.PageRouteInfo<void> {
  const ImmediateMemoryRoute({List<_i7.PageRouteInfo>? children})
      : super(
...
class PersistenceAttentionRoute extends _i7.PageRouteInfo<void> {
  const PersistenceAttentionRoute({List<_i7.PageRouteInfo>? children})
      : super(
...
class SelectAttentionRoute extends _i7.PageRouteInfo<void> {
  const SelectAttentionRoute({List<_i7.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i6.TestLogPage]
class TestLogRoute extends _i7.PageRouteInfo<void> {
  const TestLogRoute({List<_i7.PageRouteInfo>? children})
      : super(
          TestLogRoute.name,
          initialChildren: children,
        );
